declare namespace preact {
    ...
    interface ComponentLifecycle<PropsType, StateType> {
        ...
        componentWillReceiveProps?(props: PropsType, context?: any): void;
        shouldComponentUpdate?(props: PropsType, state: StateType, context?: any): boolean;
    ...
    abstract class Component<PropsType, StateType> implements ComponentLifecycle<PropsType, StateType> {
        ...
        abstract render(props: PropsType & ComponentProps, state: StateType, context: any): JSX.Element;
    }
    ...
    function cloneElement(element: JSX.Element, props: any, ...children: (JSX.Element | JSX.Element[] | string)[]): JSX.Element;
